...
try:
	with open('waiting_list_transactions.log', 'r') as file:
		data = file.readlines()
	...
	print(e)
	print("Something bad happened while reading waiting_list")
...
class Client:
	...
	def sendTransaction(self, s):
		if len(sys.argv) > 1 and self.add_miner == False:
